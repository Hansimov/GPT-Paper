...
**PyMuPDF**, **httpx**, **markdown2**, **PyDeepLX**, **deep-translator**, **Pygments**, **lxml**, **thefuzz*, **requests-html**

```sh
pip install pymupdf httpx markdown2[all] PyDeepLX deep-translator Pygments lxml thefuzz requests-html
```
